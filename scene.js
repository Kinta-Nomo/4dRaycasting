...
for (let i = 0; i<100; i++){
    scene.push(new Triangle(new Vector(Math.random()*x - (x/2),Math.random()*x - (x/2),Math.random()*x - (x/2)), new Vector(Math.random()*x - (x/2),Math.random()*x - (x/2),Math.random()*x - (x/2)), new Vector(Math.random()*x - (x/2),Math.random()*x - (x/2),Math.random()*x - (x/2)), new Color(Math.random()*255, Math.random()*255, Math.random()*255)));
}
